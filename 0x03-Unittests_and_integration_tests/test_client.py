...
class TestGithubOrgClient(unittest.TestCase):
    ...
    # Task 4: Parameterize and patch get_json as decorator for org property
    ...
    # Task 5: Mocking a property for _public_repos_url
    ...
    # Task 6: More patching for public_repos method
    @patch('client.get_json')
...
# Task 8: Integration test using fixtures and parameterized_class
@parameterized_class([
    {
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # requests.get().json() returns a Mock, so mock the chain:
        mock_response = unittest.mock.Mock()
        mock_response.json.side_effect = lambda: json_side_effect(cls.mock_get.call_args[0][0])
